...
<div class="bg-dark text-light pt-5 pb-5 border-2 border-top border-bottom border-light border-botttom">
    <p class='sombra text-center tamanio'>QUIENES SOMOS</p>
</div>
<div class="sombra text-light ml-5 mr-5 text-center">
    <p class="text-center pt-5 pb-5">Bienvenidos a ALJOR S.L, su proveedor de confianza de componentes informáticos de alta calidad. Nos enorgullecemos de ser una empresa dedicada a satisfacer las necesidades de nuestros clientes, ofreciendo productos y servicios excepcionales a precios competitivos.

Desde nuestros comienzos en el mercado de la tecnología, nos hemos dedicado a trabajar con las mejores marcas y fabricantes del sector, lo que nos permite ofrecer una amplia gama de componentes de alta calidad a nuestros clientes. En ALJOR S.L, nuestro objetivo es garantizar que nuestros clientes obtengan los productos que necesitan para hacer crecer sus negocios y satisfacer sus necesidades tecnológicas.

Nuestro equipo está compuesto por expertos en el campo de la tecnología, quienes cuentan con una amplia experiencia y conocimientos para ayudar a nuestros clientes a tomar decisiones informadas sobre los productos que mejor se adapten a sus necesidades. Nos enorgullece contar con un personal altamente capacitado y dedicado a ofrecer un servicio excepcional a nuestros clientes.

En ALJOR S.L, la calidad es nuestra máxima prioridad. Nos aseguramos de que todos nuestros productos sean inspeccionados y probados antes de salir de nuestras instalaciones, lo que nos permite garantizar que nuestros clientes reciban productos de calidad y duraderos.

Nos esforzamos por establecer relaciones de confianza con nuestros clientes, y nos enorgullece contar con una base de clientes leales que han confiado en nosotros durante años. Nuestro compromiso con la satisfacción del cliente se refleja en todo lo que hacemos, desde la calidad de nuestros productos hasta la excelencia de nuestro servicio al cliente.

En resumen, en ALJOR S.L somos una empresa dedicada a ofrecer productos y servicios de alta calidad en el sector de la tecnología. Nuestro compromiso con la calidad, la excelencia en el servicio al cliente y la satisfacción del cliente son la base de todo lo que hacemos. Gracias por confiar en nosotros como su proveedor de confianza de componentes informáticos.</p>
</div>
<!--PIE DE PÁGINA-->
