...
<!--CONTACTO-->
<div class="bg-dark text-light pt-5 pb-5 border-bottom border-top border-light border-botttom">
    <p class="sombra contacto">CONTACTO</p>
</div>
<div class="sombra text-light ml-5 mr-5 ">
    <p class="text-center pt-5 pb-5">

    Formas de Contacto con ALJOR S.L: Manteniendo una Comunicación Directa <br>

En ALJOR S.L, nos esforzamos por brindar un servicio excepcional a nuestros clientes y garantizar una experiencia de compra satisfactoria. Valoramos tu opinión, tus consultas y tus necesidades, y por eso queremos que nos contactes de la forma que te resulte más conveniente. A continuación, te presentamos las distintas vías de comunicación disponibles para que puedas contactar con nosotros. <br> <br>

    <strong>Teléfono:</strong> Nuestro equipo de atención al cliente está a tu disposición a través de nuestro número de teléfono principal: 910 503 345. Si tienes alguna pregunta relacionada con nuestros productos, necesitas asesoramiento técnico o deseas realizar una consulta sobre un pedido, estaremos encantados de ayudarte. Nuestro personal capacitado te brindará la atención personalizada que mereces. <br> <br>

    <strong>Correo Electrónico:</strong> Si prefieres una forma de comunicación escrita, puedes enviarnos un correo electrónico a aljorsl@gmail.com. Responderemos a tus consultas en el menor tiempo posible. Ya sea que necesites información adicional sobre un producto, asistencia técnica o cualquier otra pregunta relacionada con nuestra tienda, nuestro equipo de atención al cliente estará encantado de proporcionarte una respuesta clara y precisa. <br> <br>

    <strong>Redes Sociales:</strong> ¡Síguenos en nuestras redes sociales! Estamos presentes en plataformas como Facebook, Twitter e Instagram. A través de estas redes, podrás mantenerte al tanto de nuestras últimas novedades, promociones especiales y eventos. Además, podrás contactarnos enviándonos mensajes directos o dejando comentarios en nuestras publicaciones. Estaremos encantados de responder a tus consultas y de interactuar contigo en un entorno familiar y amigable. <br> <br>

    <strong>Visita a Nuestra Tienda:</strong> Si te encuentras en nuestra área local, te invitamos a visitar nuestra tienda física en Calle del Torno, 2-4, 28522 Rivas-Vaciamadrid, Madrid, España. Aquí, podrás conocer nuestro amplio catálogo de productos, hablar con nuestro personal experto y recibir asesoramiento en persona. Valoramos el contacto directo con nuestros clientes y estamos comprometidos en ofrecer un servicio de calidad en cada interacción. <br> <br>

En ALJOR S.L, nos enorgullece proporcionar múltiples opciones de contacto para que puedas elegir la forma que mejor se adapte a tus preferencias y necesidades. Estamos comprometidos en brindar respuestas rápidas y soluciones efectivas a todas tus consultas. No dudes en contactarnos a través del método que te resulte más cómodo. ¡Estamos aquí para ayudarte!</p>
</div>
<!--PIE DE PÁGINA-->
