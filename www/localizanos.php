...
<head>
    ...
    <link rel="stylesheet" href="/css/localizanos.css">
...
<div class="bg-dark text-light pt-5 pb-5 border-2 border-top border-bottom border-light border-botttom">
    <p class="sombra text-center titulo">LOCALÍZANOS</p>
</div>
<div class="sombra text-light ml-5 mr-5 text-center">
    <p class="text-center pt-5 pb-5">Ubicación de ALJOR S.L: Encuéntranos en Rivas-Vaciamadrid, Madrid, España

ALJOR S.L tiene el placer de atender a sus clientes desde su ubicación en Rivas-Vaciamadrid, Madrid, España. Nuestra tienda se encuentra en la Calle del Torno, número 2-4, en una de las zonas más dinámicas y accesibles de la ciudad.

Si visitas nuestra tienda física, te darás cuenta de que nuestra ubicación estratégica nos convierte en un destino conveniente para los entusiastas de la informática y los amantes de la tecnología en general. Nos encontramos en el corazón de Rivas-Vaciamadrid, una localidad vibrante y de rápido crecimiento, conocida por su ambiente acogedor y su comunidad activa.

Para aquellos que se desplazan en automóvil, ofrecemos amplias opciones de estacionamiento en las inmediaciones de nuestra tienda. Así podrás disfrutar de una experiencia de compra sin complicaciones y sin preocuparte por la búsqueda de un lugar para aparcar.

Si prefieres utilizar el transporte público, estaremos encantados de recibirte. La Calle del Torno es fácilmente accesible mediante varias líneas de autobuses y estaciones de metro cercanas. Además, nuestra ubicación estratégica nos permite estar bien conectados con las principales vías de transporte de la ciudad, lo que facilita tu visita desde cualquier punto de Madrid y sus alrededores.

En ALJOR S.L, nos esforzamos por crear un ambiente acogedor y profesional en nuestra tienda. Una vez que llegues a nuestra dirección en la Calle del Torno, serás recibido por nuestro amable personal, listo para brindarte asesoramiento experto y ayudarte en todo lo que necesites.

Te invitamos a visitarnos en nuestra ubicación en Rivas-Vaciamadrid para descubrir nuestra amplia gama de componentes informáticos, periféricos y accesorios de última generación. Ya sea que estés buscando actualizar tu equipo actual o necesites orientación en la selección de los mejores productos para tus necesidades, nuestro equipo estará encantado de ayudarte.

En ALJOR S.L, nos enorgullece servir a la comunidad de Rivas-Vaciamadrid y más allá, brindando productos de calidad y un servicio excepcional a nuestros clientes. ¡Esperamos poder recibirte en nuestra tienda y mostrarte todo lo que tenemos para ofrecerte!</p>
</div>
<!--MAPS-->
<div class="d-flex justify-content-center pb-5">
<iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3038.403899008314!2d-3.5262677850272037!3d40.33178546692406!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd422ed7f39df26d%3A0x54740f333e99df1!2sCalle%20del%20Torno%2C%202-4%2C%2028522%20Rivas-Vaciamadrid%2C%20Madrid%2C%20Spain!5e0!3m2!1sen!2sus!4v1620422311719!5m2!1sen!2sus"
    frameborder="0"
    allowfullscreen
  ></iframe>
</div>
